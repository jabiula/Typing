	...
	{
		{
			...
			{new KeyText("Ctrl","Ctrl",80),new KeyText("fn","fn",0),new KeyText("start","start",0),new KeyText("Alt","Alt",60),new KeyText("                       Space","                       Space",370),new KeyText("Alt","Alt",50),new KeyText("","",8),new KeyText("Ctrl","Ctrl",68),new KeyText("","",40),new KeyText("","",40),new KeyText("","",40),new KeyText("","",40),new KeyText("","",40),new KeyText("","",40)}
		},

		{
			{new KeyText("","",40),new KeyText("ज्ञ","१",40),new KeyText("","२",40),new KeyText("घ","३",40),new KeyText("","४",40),new KeyText("छ","५",40),new KeyText("ट","६",40),new KeyText("ठ","७",40),new KeyText("ड","८",40),new KeyText("ढ","९",40),new KeyText("","०",40),new KeyText("","-",40),new KeyText("","=",40),new KeyText("  Back","  Back",87)},
			...
			{new KeyText("Caps","Caps",74),new KeyText("","ब",40),new KeyText("","क",40),new KeyText("","म",40),new KeyText("","ा",40),new KeyText("","न",40),new KeyText("","ज",40),new KeyText("","व",40),new KeyText("","प",40),new KeyText(" ी"," ि",40),new KeyText(":","स",40),new KeyText("\"","'",40),new KeyText("|","\\",101),new KeyText("hide","hide",40)},
			...
			{new KeyText("Ctrl","Ctrl",80),new KeyText("fn","fn",0),new KeyText("start","start",0),new KeyText("Alt","Alt",60),new KeyText("                       Space","                       Space",370),new KeyText("Alt","Alt",60),new KeyText("","",8),new KeyText("Ctrl","Ctrl",78),new KeyText("","",40),new KeyText("","",40),new KeyText("","",40),new KeyText("","",40),new KeyText("","",40),new KeyText("","",40)}
		}
	};
